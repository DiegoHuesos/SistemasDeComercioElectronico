 ...
 * 
 */
@WebServiceClient(name = "miServicioWeb", targetNamespace = "http://serviciosweb/", wsdlLocation = "http://148.205.199.131:8080/MisWebServices/miServicioWeb?WSDL")
    ...
    extends Service
{
    ...
    private final static QName MISERVICIOWEB_QNAME = new QName("http://serviciosweb/", "miServicioWeb");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://148.205.199.131:8080/MisWebServices/miServicioWeb?WSDL");
    ...
    public MiServicioWeb getMiServicioWebPort() {
        return super.getPort(new QName("http://serviciosweb/", "miServicioWebPort"), MiServicioWeb.class);
    }
    ...
    public MiServicioWeb getMiServicioWebPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://serviciosweb/", "miServicioWebPort"), MiServicioWeb.class, features);
    }
